...
resource "intersight_server_profile" "Server-Profile" {
  ...
  policy_bucket = [
    {
      moid = module.policies_for_linux_fc_boot.bios_policy_moid,
    ...
    {
      moid = module.policies_for_linux_fc_boot.boot_policy_for_fc_moid,
    ...
    {
      moid = module.policies_for_linux_fc_boot.intersight_access_policy_moid,
    ...
    {
      moid = module.policies_for_linux_fc_boot.lan_connectivity_policy_moid,
    ...
    {
      moid = module.policies_for_linux_fc_boot.san_connectivity_policy_moid,
