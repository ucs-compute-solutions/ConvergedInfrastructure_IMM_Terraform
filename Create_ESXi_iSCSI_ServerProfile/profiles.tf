...
resource "intersight_server_profile" "Server-Profile" {
  ...
  module.policies_for_esxi_iscsi_boot]

  target_platform = "FIAttached"

  policy_bucket = [
    {
      moid                  = module.policies_for_esxi_iscsi_boot.bios_policy_moid,
    ...
    {
      moid                  = module.policies_for_esxi_iscsi_boot.boot_policy_for_iscsi_moid,
    ...
    {
      moid                  = module.policies_for_esxi_iscsi_boot.intersight_access_policy_moid,
    ...
    {
      moid                  = module.policies_for_esxi_iscsi_boot.lan_connectivity_policy_moid,
